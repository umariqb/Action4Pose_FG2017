...
namespace pion {    // begin namespace pion
    ...
    protected:
        inline void set_what_msg(const char * const msg = NULL, const std::string * const arg1 = NULL, const std::string * const arg2 = NULL, const std::string * const arg3 = NULL) const {
            ...
            tmp << msg; //( msg ? msg : boost::units::detail::demangle(BOOST_EXCEPTION_DYNAMIC_TYPEID(*this).type_->name()) );
#else
...
#if BOOST_VERSION >= 104700
            tmp << BOOST_EXCEPTION_DYNAMIC_TYPEID(e).type_->name(); //boost::units::detail::demangle(BOOST_EXCEPTION_DYNAMIC_TYPEID(e).type_->name());
#else
